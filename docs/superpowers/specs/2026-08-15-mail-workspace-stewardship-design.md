...
| Security reviewer | Surface suspicious signals and unsafe requests while distinguishing observed evidence from inference | [NIST SP 800-177 Rev. 1](https://csrc.nist.gov/pubs/sp/800/177/r1/final) and [CISA phishing guidance](https://www.cisa.gov/sites/default/files/2023-09/CISA_Web-Page-Animation_Phishing_Audio-Description.pdf), reviewed every six months | Does not certify authenticity, classify spam, open links, execute attachments, or replace a security professional |
