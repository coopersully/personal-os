...
function addLoadedWorkspace(
  ...
  data.calendarEvents.push(
    ...
    },
    {
      calendarId: localCalendarId,
      createdAt: ago(34),
      endsAt: at(today, 11 * 60 + 20),
      id: fixtureId(account, 109),
      location: "Project room",
      provider: "local",
      reminders: [],
      startsAt: at(today, 10 * 60 + 35),
      status: "confirmed",
      timezone,
    ...
    },
    {
      ...
      createdAt: ago(33),
      endsAt: at(today, 11 * 60 + 15),
      id: fixtureId(account, 110),
      provider: "google",
      raw: { fixture: true },
      remoteEventId: `partner-launch-${todayIso}`,
      startsAt: at(today, 10 * 60 + 40),
      status: "confirmed",
      syncedAt: ago(1),
      timezone,
      title: "Partner launch sync",
      updatedAt: now,
      userId: account.id,
    },
    {
      calendarId: workCalendarId,
      createdAt: ago(32),
      endsAt: at(today, 11 * 60 + 25),
      id: fixtureId(account, 111),
      provider: "google",
      raw: { fixture: true },
      remoteEventId: `hiring-calibration-${todayIso}`,
      startsAt: at(today, 10 * 60 + 50),
      status: "tentative",
      syncedAt: ago(1),
      timezone,
    ...
    {
      blockMode: "busy",
      blockSourceEventId: fixtureId(account, 104),
      calendarId: workCalendarId,
      createdAt: ago(23),
      endsAt: at(today, 15 * 60 + 30),
      id: fixtureId(account, 107),
      provider: "google",
      raw: { fixture: true },
      remoteEventId: `focus-work-block-${todayIso}`,
      startsAt: at(today, 14 * 60),
      status: "confirmed",
      syncedAt: ago(1),
      timezone,
    ...
    },
    {
      ...
      createdAt: ago(22),
      endsAt: at(today, 15 * 60 + 30),
      id: fixtureId(account, 108),
      provider: "google",
      raw: { fixture: true },
      remoteEventId: `focus-family-block-${todayIso}`,
      startsAt: at(today, 14 * 60),
      status: "confirmed",
      syncedAt: ago(1),
      timezone,
